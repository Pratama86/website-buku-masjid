<div class="pt-4 pt-sm-0">
    <div class="d-flex align-items-end gap-2 align-items-end overflow-scroll">
        <div id="Imsak" class="pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 240px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat; background-position: 0 -30px">
            <div class="prayinfo">
        ...
        <div id="Subuh" class="pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 200px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat;background-position: -95px -70px">
            <div class="prayinfo">
                @if (config('features.shalat_time.is_active'))
        ...
        <div id="Dzuhur" class="pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 210px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat;background-position: -190px -60px">
            <div class="prayinfo">
                @if (config('features.shalat_time.is_active'))
        ...
        <div id="Ashar" class=" pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 270px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat;background-position: -285px 0px">
            <div class="prayinfo">
                @if (config('features.shalat_time.is_active'))
        ...
        <div id="Maghrib" class="pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 200px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat;background-position: -380px -70px">
            <div class="prayinfo">
                @if (config('features.shalat_time.is_active'))
        ...
        <div id="Isya" class="pray-off bg-secondary praytime-item d-flex align-items-end col" style="height: 230px; background-image: url('{{ asset('uploads/'.Setting::get('masjid_photo_path'))}}'); background-repeat: no-repeat;background-position: -475px -40px">
            <div class="prayinfo">
                @if (config('features.shalat_time.is_active'))
